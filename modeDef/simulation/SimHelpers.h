...
void TestConstraints(CBody* b)
{
  ...
  std::cout << "A response: " << std::endl << m << std::endl;
  ...
  std::cout << "Predicted a, force 100 applied: " << a + m*f << std::endl;
  ConstraintAError(&c, a);
  std::cout << "New a, force 100 applied: " << a << std::endl;
  ...
  ConstraintAError(&c, a);
  ConstraintAResponse(&c, &c, m);
  std::cout << "A response: " << std::endl << m(0, 0) << std::endl;
  ...
  std::cout << "Old a: " << a[0] << std::endl;
  std::cout << "Predicted a, force 50 applied: " << a[0] + m(0, 0)*f[1] << std::endl;
  ConstraintAError(&c, a);
  std::cout << "New a, force 50 applied: " << a[0] << std::endl;
